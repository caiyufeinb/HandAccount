...
import com.example.handaccount.Adapter.FruitAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snackbar.make(v, "是否添加新手账", Snackbar.LENGTH_SHORT)
                        .setAction("添加", new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                Toast.makeText(HomePageActivity.this, "新手账已经添加", Toast.LENGTH_SHORT).show();
                            }
                        }).show();
            }
        });
